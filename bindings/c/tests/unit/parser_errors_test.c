...
static void test_hint_alt_no_lhs(void **state)
{
    ...
    verify_error_content(input, "Invalid Node"); // "Missing 'type' or 'kind' field"
}
...
static void test_hint_quantify_anchor(void **state)
{
    ...
    verify_error_content(input, "Target cannot be an Anchor");
}
...
static void test_hint_undefined_backref(void **state)
{
    ...
    // verify_error_content(input, "undefined"); // Not implemented yet
    (void)input;
}
...
static void test_hint_duplicate_name(void **state)
{
    ...
    const char *input =
        ...
        "{\"type\": \"Group\", \"capturing\": true, \"name\": \"n\", \"expression\": {\"type\": \"Dot\"}}"
        "]}";
    // verify_error_content(input, "Duplicate"); // Not implemented yet
    (void)input;
}
...
static void test_hint_inline_modifiers(void **state)
{
    ...
    verify_error_content(input, "Unknown node type");
}
...
static void test_hint_unterminated_unicode(void **state)
{
    ...
    verify_error_content(input, "Invalid Escape node");
}
...
static void test_complex_free_spacing_error(void **state)
{
    ...
    verify_error_content(input, "Missing 'target'");
}
